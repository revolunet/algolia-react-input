...
export default class AlgoliaInput extends Component {
  ...
  render() {
    return (
      <div>
        <input style={ { WebkitUserSelect: 'auto', userSelect: 'auto' } } onKeyUp={ this.onKeyUp } placeholder={ this.props.placeholder } type='text' className={ this.props.className || 'algolia-react-input' } />
      </div>
    );
  }
